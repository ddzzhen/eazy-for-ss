...
function get_info_from_net(){
    ...
    OC_version_latest=$(curl -s "https://ocserv.gitlab.io/www/download.html" | sed -n 's/^.*version is <b>\(.*$\)/\1/p')
}
...
NET_OC_CONF_DOC="https://raw.githubusercontent.com/ddzzhen/eazy-for-ss/ocserv11/ocservauto"
#推荐的默认版本
